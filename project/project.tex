...
Some chemical reaction might change the molecules characteristics so
it loses the ability to fluorescence, which is called
\e{\x{photo-bleaching}}. Some other reaction may re-enable the
fluorescence, that is one of the reasons for the use of \x{buffers} in
\gls{smlm}.
