...
\begin{figure}[h]
  ...
  \caption{
    ...
    non-radiative decay, and fluorescence. Obtained under \protect\tt{CC0}
    license from \protect\cite{ja22}.
  }
  \label{f:asdf}
\end{figure}
...
hours, until it eventually falls back to ground state, emitting a
lower energy photon $h\nu$. This effect was once considered a separate
...
\begin{figure}[h]
  ...
  \caption{
    ...
    degree and horizontally by azimuthal degree, obtained under \tt{CC-BY-SA}
